...
export default function ConsensusView({ consensus }: ConsensusViewProps) {
  ...
  return (
    <div className="bg-slate-800 rounded-lg p-6 border border-slate-700">
      <h3 className="text-xl font-bold mb-4">🤖 AI Expert Consensus</h3>
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        >
          ...
          <div>
            <p className="text-sm uppercase tracking-wide">Consensus</p>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4 text-center">
          ...
          <p className="text-sm text-slate-400 mt-1">Bullish</p>
        ...
        <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4 text-center">
          ...
          <p className="text-sm text-slate-400 mt-1">Bearish</p>
          <p className="text-xs text-slate-500 mt-1">
            {totalVotes > 0
        ...
        <div className="bg-slate-500/10 border border-slate-500/30 rounded-lg p-4 text-center">
          ...
          <p className="text-sm text-slate-400 mt-1">Neutral</p>
          <p className="text-xs text-slate-500 mt-1">
            {totalVotes > 0
